...
class NotificationService:
    """Service for budget notifications"""
    ...
    def check_budget_limits(user_id):
        ...
        for category in categories:
            ...
            budget_used_percent = (total_expense / category.budget_limit) * 100
            
            # Check thresholds and create notifications
            thresholds = [(90, f"You've used 90% of your {category.name} budget this month."),
